...
NOTE #1: This is a simple help file for the AZTEC 'c' compiler
	 error codes.  Make appropriate changes in the text at
	 the respective case switches and apply this program
	 to other compilers, etc.

NOTE #2: For concept see K & R, Chapter 3.4, pages 54-56.
...

{
  ...
  puts("\nCopyright (c) 1984  Karl L. Remmler\n\n");
  if (argc != 2) { /* . . . . . . . . . . . . . . proper # of arguments? */
	puts("\nUsage: A>EX17 ERROR# <cr>\n");
  ...
  switch (code) {
	...
	break;
    default:
	puts("\nYOU ARE IN BAD BAD Ceeeee TROUBLE\n");
  }
  exit(0);
}
xit(0);
